...
public class RecetasPropias extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_recetas_propias, container, false);
        ...
        if (username != null) {
            Log.d("RecetasPropias", "Nombre de usuario recibido: " + username);
            ...
            Log.e("RecetasPropias", "El nombre de usuario es nulo");
            startActivity(new Intent(requireContext(), MainActivity.class)); // Iniciar la actividad de inicio de sesión
        }
